                ...
                <div class="mid-header-wrap">
                    ...
                    <ul class="header-info">
                        ...
                        <li>
                            ...
                            <div class="header-info-text">
                                <h3><span>Email now</span>info@microtechglobal.co.uk</h3>
                            </div>
                        </li>
                        <li>
                            <div class="header-info-icon">
            ...
            <div class="row">
                <div class="col-lg-8 sm-padding">
                    <div class="service-details-info">
                        <h2>TheWhiteCab Trust us to get you there :</h2>
                        <p>
                            We offer a 24 hour airport transfer service across UK to all travelers flying to or from any major airport in UK, we specialize in UK Airport transfers including Heathrow Airport, Gatwick Airport, Stansted Airport, London City & Luton Airport etc. As well as London Airports we also cover other popular destinations including Southampton, Portsmouth, Harwich and Dover sea ports.
                            To get our cordial service, call us: our 24 hour WhiteCab call center is open now and waiting for your call.</p>
                        ...
                        <h2>TheWhiteCab To All Major Airports :</h2>
                        <p>Our airport taxi service covers all major Airports in the UK 24 hours a day, 365 days a year. Our airport cars are available right across the UK and can often be booked at short notice. Our friendly, professional drivers can collect you and your party and transfer you directly to the airport of your choice whilst we track the progress of your journey and ensure your driver has the latest travel information.</p>
                        <div class="service-details-list">
                            <img src="assets/img/car-2.png" alt="img">
                            <div>
                        ...
                        <h2>Our Range of Airport Vehicles :</h2>
                        <p>We provide all sorts of cars, Vans, SUVs as per your demand. Conditions of these vehicles are superb. We make sure that you can make no complaint about the vehicles we provide in a very reasonable price.</p>
                    </div>
                </div>
                <div class="col-lg-4 sm-padding">
                    ...
                    <div class="sidebar-widget banner" style="display: none;">
