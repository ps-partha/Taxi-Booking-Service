                ...
                <div class="testimonial-carousel-2 swiper-container">
                    <div class="swiper-wrapper">
                            ...
                            <div class="testi-item">
                                ...
                                <div class="testi-author">
                                    ...
                                    <div class="author-info">
                                        <h3>Sean Winter<span>Financial .INC</span></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testi-item">
                                <div class="quote-icon"><i class="las la-quote-right"></i></div>
                                <p>Great taxi booking experience! Prompt and efficient service. The driver was courteous and knew the routes well. The vehicle was clean and comfortable. Reasonable pricing. Highly recommended for stress-free transportation.</p>
                                <div class="testi-author">
                                    <div class="author-thumb"><img src="assets/img/comment-2.png" alt="author"></div>
                                    <div class="author-info">
                                        <h3>Kai Goodwin <span>Financial .INC</span></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testi-item">
                                <div class="quote-icon"><i class="las la-quote-right"></i></div>
                                <p>Disappointing taxi booking experience. The app was glitchy and hard to navigate, causing delays in the reservation process. The driver arrived late, and the ride was uncomfortable due to a poorly maintained vehicle. Additionally, the fare was unexpectedly high, and customer service was unresponsive to resolve the issue. Will not be using this service again.</p>
                                <div class="testi-author">
                                    <div class="author-thumb"><img src="assets/img/comment-3.png" alt="author"></div>
                                    <div class="author-info">
                                        <h3>William Hill <span>Financial .INC</span></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
