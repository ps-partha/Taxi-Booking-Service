...
<head>
    ...
    <title>Ridek - Online Taxi Booking Service</title>
...
<body>
        ...
        <div class="mid-header">
            <div class="container">
                <div class="mid-header-wrap">
                    <div class="site-logo">
                        <a href="index.html"><img src="assets/img/logo-dark.png" width="100%" alt="Logo"></a>
                    </div><!--/.site-logo-->
                    <ul class="header-info">
                        <li>
                            ...
                            <div class="header-info-text">
                                <h3><span>Call us now</span><a href="tel:+442081441575">+442081441575</a></h3>
                            </div>
                        </li>
                        <li>
                            <div class="header-info-icon">
                            ...
                            <div class="header-info-text">
                                <h3><span>Email now</span>info@microtechglobal.co.uk
                                </h3>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="header-info-text">
                                <h3><span>Icon office Building
                                        Office 48</span>321-323 High Road , Chadwell Heath
                                    RM6 6AX, UK</h3>
                            </div>
                        </li>
                    </ul>
    ...
    <div id="popup-sidebox" class="popup-sidebox">
        <div class="sidebox-content">
            <div class="site-logo">
                <a href="index.html"><img src="assets/img/logo-light.png" width="100%" alt="logo"></a>
            </div>
            <p>Everything your taxi business needs is already here! Ridek, a theme
                made for taxi service companies.</p>
            <ul class="sidebox-list">
                <li class="call"><span>Call for ride:</span>+442081441575</li>
                <li>
                    <span>You can find us at:</span>MICROTECHGLOBALUK LTD.
                    Icon office Building
                    Office 48, 321-323 High Road , Chadwell Heath
                    RM6 6AX, United Kingdom
                </li>
                <li><span>Email now:</span>info@microtechglobal.co.uk</li>
            </ul>
        </div>
    </div>
    <!--/.popup-sidebox-->
        ...
        <div class="main-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="slider-img"><img src="assets/img/bg-1.jpg" width="100%" alt="img" class="kenburns"
                            style="animation-duration: 12000ms; "></div>
                    <div class="car-holder">
                        <img src="assets/img/car-1.png" width="100%" alt="car" data-animation="car-animation"
                            data-duration="1.5s">
                        <div class="shape">
                ...
                <div class="swiper-slide">
                    <div class="slider-img"><img src="assets/img/home.jpg" alt="img" class="kenburns"
                            style="animation-duration: 12000ms; "></div>
                    <div class="car-holder">
    ...
    <section class="about-section padding">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="about-img">
                        <img class="about-img1 wow fade-in-left" data-wow-delay="200ms" src="assets/img/450 by 580.jpg"
                            width="100%" alt="img">
                        <img class="about-img2 wow fade-in-bottom" data-wow-delay="400ms"
                            src="assets/img/400 by 450.jpg" width="100%" alt="img">
                ...
                <div class="col-md-6">
                    ...
                    <div class="accordion-item" style="margin-bottom: 20px;">
                        <p class="HeadText">Embrace the quintessential London experience by hopping into one of the iconic white cabs. These traditional taxis have been an integral part of London’s transportation landscape for generations. Riding in a white cab is not just a means of getting from point A to point B; it’s a cultural experience in itself.</p>
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faq-accordion">
                            <div class="accordion-body">
                               <p>The drivers, famously known as “cabbies,” are highly knowledgeable about London’s streets and landmarks
                                Keep in mind that white cabs can be more expensive than other options, especially during peak hours, but the convenience and local insight they offer are well worth the cost.
                                For a more personalized  and comfortable journey, consider booking an airport transfer service in advance. These private transportation options cater to your specific needs, ensuring a seamless transfer from Airports or any other destination within the city.
                                Airport transfer services provide various vehicle types to accommodate different group sizes and luggage requirements. Whether you’re traveling solo, with family, or a larger group, you can find a suitable vehicle to suit your needs.
                                The chauffeurs of these services are professional and well-versed in navigating London’s traffic, ensuring a smooth and stress-free journey. Booking in advance also offers peace of mind, as you can rest assured that a dedicated driver will be waiting for you upon arrival, ready to assist you with your belongings and transport you to your destination with utmost care.</p>
                            </div>
                    ...
                    <ul class="about-info wow fade-in-right" data-wow-delay="400ms">
                        <li>
                            <img class="owner-thumb" src="assets/img/auhtor.png" alt="thumb">
                            <div class="owner">
                                <h4>Founder - CEO</h4>
                        ...
                        <li>
                            <h2><span>Call For Taxi</span><a href="tel:+442081441575">+442081441575</a></h2>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <form action="book-ride.php" id="book-taxi-ride">
                            <div class="booking-form">
                                ...
                                <div class="form-field" id="TimeField">
                                    ...
                                    <input id="ride-time" name="ride-time" class="form-control" readonly>
                                    <div id="TimeField">
                                        <ul class="DatePIC">
                                            <li><input type="text" id="Dinput" name="HH" class="otp-field" maxlength="2" placeholder="11" required ></li><span style="color: #fff;"> :</span>
                                            <li><input type="text" id="Dinput" name="MI" class="otp-field" maxlength="2" placeholder="00" required>
                                            </li>
                                            <li><input type="text" id="DinputAM" name="AM" class="otp-field" maxlength="2" placeholder="AM"
                                                   required >
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testi-item">
                                        ...
                                        <p>Outstanding taxi booking service! The app was seamless and straightforward to use, making the reservation process a breeze. The driver was punctual, friendly, and drove safely throughout the journey. The car was spotless and provided a comfortable ride. Moreover, the fare was reasonable, and there were no hidden charges. Highly impressed and will definitely be a returning customer!</p>
                                        <div class="testi-author">
                                            <div class="author-thumb"><img src="" alt="author">
                                            </div>
    ...
    <section class="cta-section padding">
        ...
        <div class="container">
            <div class="cta-content">
                ...
                <div class="cta-call">
                    <i class="las la-phone-volume"></i>
                    <p><span>Call For Taxi</span><a href="tel:+442081441575">+442081441575</a></p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="footer-top">
                    <div class="row align-items-end">
                        <div class="col-lg-8">
                            <div class="brand">
                                <a class="footer-logo" href="index.html"><img src="assets/img/logo-light.png"
                                        alt="logo"></a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 sm-padding">
                        <div class="footer-item">
                            ...
                            <ul class="footer-contact">
                                <li><span>Location:</span>MICROTECHGLOBALUK LTD.
                                    Icon office Building
                                    Office 48, 321-323 High Road , Chadwell Heath
                                    RM6 6AX, United Kingdom </li>
                                <li><span>Join Us:</span>info@microtechglobal.co.uk</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 sm-padding">
